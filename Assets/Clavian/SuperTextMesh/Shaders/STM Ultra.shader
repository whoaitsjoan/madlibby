Shader "Super Text Mesh/Ultra" {
	...
	SubShader {
		...
		// a) uncommon use-case vs. efficiency
		// b) this seems to cause some errors with UI because of the ZWrite On line
		// c) if shadows are needed, this shader can be easily duplicated and the pass below uncommented
		// maybe potentially set ZWrite to Off if it's UI mode? how...
