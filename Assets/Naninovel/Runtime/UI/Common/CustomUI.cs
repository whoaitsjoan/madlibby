...
namespace Naninovel.UI
{
    ...
    public class CustomUI : ScriptableUIBehaviour, IManagedUI
    {
        ...
        private readonly HashSet<IManagedUI> modalUIs = new HashSet<IManagedUI>();
        ...
        protected bool ShouldHandleBoundInput (bool whenHidden, bool whenBlocked)
        {
            ...
            modalUIs.Clear();
            uiManager.GetModalUIs(modalUIs);
            return modalUIs.Count == 0 || uiManager.IsActiveModalUI(this);
        }
